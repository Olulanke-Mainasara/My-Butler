    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 -mt-32 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-xl p-8 md:p-12 shadow-2xl mb-12">
          ...
          <div className="bg-white rounded-xl p-8 md:p-12 shadow-sm border">
            ...
            {/* Author Bio Skeleton */}
            <div className="flex items-start gap-4 p-6 bg-linear-to-r from-gray-50 to-blue-50 rounded-xl">
