...
-- access, this can be run directly in the SQL editor to unblock checkout
-- without waiting on the MCP tool - once applied, rename this file to match
-- the version Supabase assigns so the repo matches reality.
